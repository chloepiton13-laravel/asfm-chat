                ...
                @auth
                    ...
                    <div class="relative">
                        ...
                        <div x-show="userOpen" x-cloak @click.away="userOpen = false"
                            ...
                            @if(auth()->user()->role === 'admin' && auth()->user()->two_factor_confirmed_at)
                                <a href="{{ route('dashboard') }}"
                                   wire:navigate
                                   class="flex items-center gap-3 px-6 py-3 text-white hover:bg-amber-500 hover:text-slate-950 transition font-bold text-[10px] uppercase tracking-widest">
